 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TestUml13CoreAssociation extends TestUml13CoreModelElement {
	
	public TestUml13CoreAssociation(String arg0) throws Exception {
		super(arg0);
	}
	...
	public void testQualifiers() {
		...
		assertEquals(1, assocEnds.size());
		assocEnd = (CoreAssociationEnd) assocEnds.get(0);
		assertAssocEnd(assocEnd, true, false , "Tape", "tapes", false);
		...
		assertEquals("is recorded in::tapes", assocEnd.getFullPathName());
	}
