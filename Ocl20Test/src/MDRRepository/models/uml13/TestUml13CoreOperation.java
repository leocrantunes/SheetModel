 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TestUml13CoreOperation extends TestUml13CoreModelElement {
	public TestUml13CoreOperation(String arg0) throws Exception {
		super(arg0);
	}
...
//		assertTrue(theOperation.hasMatchingSignature(argTypes));
	...
	public void testIsQuery() {
		List operations = getOperation("MyExample", "Film", "setRentalFee");
		CoreOperation theOperation = (CoreOperation) operations.get(0);
		assertFalse(theOperation.isQuery());

		operations = getOperation("MyExample", "Film", "getRentalFee");
		theOperation = (CoreOperation) operations.get(0);
		assertTrue(theOperation.isQuery());

		operations = getOperation(null, "SpecialFilm", "computeFee");
		theOperation = (CoreOperation) operations.get(0);
		assertFalse(theOperation.isQuery());
	}
}
