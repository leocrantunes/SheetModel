 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TestUml13CoreAssociationClass extends TestUml13CoreModelElement {

	public TestUml13CoreAssociationClass(String arg0) throws Exception {
		super(arg0);
	}
	...
	public void testNormalAssociation() {
		...
		assertFalse(allocation.isClassifierInAssociation(allocation));
