 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TestUml14CoreClassifier extends TestUml14CoreModelElement {
	public TestUml14CoreClassifier(String arg0) throws Exception {
		super(arg0);
	}
	...
	public void testImplementors() {
		...
		CoreInterface iProduct = (CoreInterface) getClassifier("MyExample", "IProduct");
		
		assertNotNull(getModelElement(iProduct.getAllImplementors(), "Product", CoreClassifier.class));
...
//		assertTrue(assoc instanceof CoreAssociationClass);
	...
	public void testLookupOverloadedOperation() {
		...
		assertNotNull(op);
		assertEquals(intType.getName(), op.getReturnType().getName());
