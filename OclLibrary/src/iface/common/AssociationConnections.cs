...
public interface AssociationConnections {
     ...
     */
    bool exists(CoreAssociation theAssociation, CoreAssociationEnd theAssociationEnds);
    /**
     ...
     */
    CoreAssociation getTheAssociation(CoreAssociationEnd theAssociationEnds);
    /**
     ...
     * @param theAssociationEnds Value of the second association end.
     */
    bool add(CoreAssociation theAssociation, CoreAssociationEnd theAssociationEnds);
    /**
     ...
     * @param theAssociationEnds Value of the second association end.
     */
    bool remove(CoreAssociation theAssociation, CoreAssociationEnd theAssociationEnds);
}
